                                ...
                                ?>
                                        <tr id="iRow_<?= $item['id'] ?>">
                                            ...
                                            <td class="n fw-600" style="color:<?= $qClr ?>">
                                                <?= number_format($qty, 2) ?>
                                                <span
                                                    style="font-weight:400;font-size:.7rem;color:#94a3b8"><?= htmlspecialchars($item['unit']) ?></span>
                                            </td>
                                            <td class="n text-muted"><?= $minQ > 0 ? number_format($minQ, 2) : '—' ?></td>
                                            <td class="n text-muted">
                                                <?= $item['estimated_cost'] > 0 ? number_format($item['estimated_cost'], 2) . ' ' . htmlspecialchars($item['currency_code'] ?? '$') : '—' ?>
                                            </td>
                                            <td>
                ...
                <div class="modal-body px-4 pt-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="mUnit" class="form-control form-control-sm"
                                placeholder="قطعة، كيلو، لتر، فاتورة">
                        </div>
                        <div class="col-md-3">
                            <label class="field-lbl">التكلفة التقديرية</label>
                            <input type="number" id="mEstCost" class="form-control form-control-sm" min="0" step="0.01"
                                placeholder="0.00">
                        ...
                        <div class="col-md-3">
                            ...
                            <select id="mCurrency" class="form-select form-select-sm">
                                ...
                                <?php foreach ($currencies as $cur): ?>
                                            <option value="<?= $cur['id'] ?>"><?= htmlspecialchars($cur['code'] . ' - ' . $cur['name']) ?>
                                            </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
