...
CREATE TABLE IF NOT EXISTS `account_charts_ret` (
  ...
  KEY `idx_code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=1020 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='شجرة الحسابات — فرع حلب';

-- Dumping data for table bayhas_local.account_charts_ret: ~50 rows (approximately)
INSERT INTO `account_charts_ret` (`id`, `code`, `name`, `description`, `parent_id`, `account_type`, `balance`, `base_balance`, `currency_id`, `exchange_rate`, `level`, `is_active`, `is_locked`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
...
-- Dumping structure for table bayhas_local.attendance_ret
CREATE TABLE IF NOT EXISTS `attendance_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `employee_id` int NOT NULL,
  `work_date` date NOT NULL,
  `status` enum('present','absent','half_day','on_leave','holiday') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'present',
  ...
  CONSTRAINT `fk_att_employee` FOREIGN KEY (`employee_id`) REFERENCES `employees_ret` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table bayhas_local.attendance_ret: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `branches` (
  ...
  `base_currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD' COMMENT 'العملة الأساسية للفرع (USD دائماً كعملة تقارير)',
...
INSERT INTO `branches` (`id`, `name`, `name_en`, `branch_type`, `phone`, `email`, `address`, `city`, `country`, `tax_number`, `factory_branch_id`, `base_currency`, `local_currency`, `pricing_method`, `default_margin_pct`, `tax_rate_default`, `allow_negative_stock`, `notify_low_stock`, `low_stock_threshold`, `notify_new_invoice`, `notify_internal_order`, `notify_email`, `invoice_prefix`, `invoice_counter`, `fiscal_year_start`, `week_start_day`, `default_payment_terms`, `code`, `table_suffix`, `dashboard_path`, `icon`, `color`, `sort_order`, `created_by`, `updated_by`, `status`, `created_at`, `updated_at`, `base_currency_id`, `local_currency_id`) VALUES
	(1, 'فرع البيع 1', 'Retail Branch 1', 'retail', '+963992326518', NULL, 'حلب - دوار السبع بحرات - باتجاه الجامع الكبير', 'حلب', 'Syria', NULL, 5, '1', '4', 'cost_plus', 10.00, 0.00, 0, 1, 5, 1, 1, NULL, 'ALP', 0, 1, 6, 30, 'ALP', 'ret', 'retail1/modules/dashboard.php', 'bi-shop-window', '#f59e0b', 1, NULL, 1, 'active', '2026-05-20 11:51:25', '2026-07-17 06:00:07', 1, 4);

-- Dumping structure for table bayhas_local.consumables_ret
CREATE TABLE IF NOT EXISTS `consumables_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'اسم المستهلك: كهرباء، قهوة، إنترنت',
  `category` enum('utility','supplies','food','maintenance','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `unit` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'وحدة القياس: كيلو، لتر، قطعة، فاتورة',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `created_by` int DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping data for table bayhas_local.consumables_ret: ~0 rows (approximately)

-- Dumping structure for table bayhas_local.consumable_entries_ret
CREATE TABLE IF NOT EXISTS `consumable_entries_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `payment_method` enum('cash','bank','card','deferred') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
  `cash_account_id` int DEFAULT NULL COMMENT 'حساب الصندوق/البنك',
  `expense_account_id` int DEFAULT NULL COMMENT 'حساب المصروف',
  ...
  CONSTRAINT `fk_ce_consumable` FOREIGN KEY (`consumable_id`) REFERENCES `consumables_ret` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='سجلات الاستهلاك — كل فاتورة = سطر مستقل';

-- Dumping data for table bayhas_local.consumable_entries_ret: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='المستهلكات — فرع حلب';

-- Dumping data for table bayhas_local.consumable_items_ret: ~5 rows (approximately)
INSERT INTO `consumable_items_ret` (`id`, `name`, `category`, `unit`, `estimated_cost`, `last_purchase_price_usd`, `last_purchase_date`, `currency_id`, `notes`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `consumable_movements_ret` (
  ...
  `reference_type` enum('purchase','sale','issue','transfer','inventory','manual') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='حركات مخزون المستهلكات — مستقلة عن الفواتير';

-- Dumping data for table bayhas_local.consumable_movements_ret: ~4 rows (approximately)
INSERT INTO `consumable_movements_ret` (`id`, `movement_no`, `item_id`, `warehouse_id`, `movement_type`, `direction`, `quantity`, `unit_cost_usd`, `total_cost_usd`, `qty_before`, `qty_after`, `reference_type`, `reference_id`, `to_warehouse_id`, `journal_entry_id`, `is_posted`, `movement_date`, `notes`, `created_by`, `created_at`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='فواتير شراء المستهلكات — رأس الفاتورة';

-- Dumping data for table bayhas_local.consumable_purchases_ret: ~1 rows (approximately)
INSERT INTO `consumable_purchases_ret` (`id`, `invoice_no`, `supplier_ref`, `supplier_id`, `warehouse_id`, `invoice_date`, `due_date`, `currency`, `exchange_rate`, `subtotal_orig`, `subtotal_usd`, `discount_pct`, `discount_usd`, `discount_orig`, `tax_pct`, `tax_usd`, `tax_orig`, `total_usd`, `total_orig`, `paid_usd`, `paid_orig`, `balance_usd`, `balance_orig`, `status`, `payment_method`, `journal_entry_id`, `is_posted`, `notes`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='تفاصيل فواتير شراء المستهلكات';

-- Dumping data for table bayhas_local.consumable_purchase_items_ret: ~4 rows (approximately)
INSERT INTO `consumable_purchase_items_ret` (`id`, `purchase_id`, `item_id`, `quantity`, `unit_price_orig`, `unit_price_usd`, `total_orig`, `discount_pct`, `total_usd`, `movement_id`, `notes`) VALUES
...
-- Dumping structure for table bayhas_local.consumable_sales_ret
CREATE TABLE IF NOT EXISTS `consumable_sales_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `invoice_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'SAL-2024-0001',
  ...
  `payment_method` enum('cash','bank','card','deferred') COLLATE utf8mb4_unicode_ci DEFAULT 'cash',
  `journal_entry_id` int DEFAULT NULL,
  `is_posted` tinyint(1) NOT NULL DEFAULT '0',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` int NOT NULL,
  ...
  KEY `idx_date` (`invoice_date`),
  KEY `idx_status` (`status`),
  CONSTRAINT `fk_csa_warehouse` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses_ret` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='فواتير بيع المستهلكات';

-- Dumping data for table bayhas_local.consumable_sales_ret: ~0 rows (approximately)

-- Dumping structure for table bayhas_local.consumable_sale_items_ret
CREATE TABLE IF NOT EXISTS `consumable_sale_items_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `sale_id` int NOT NULL COMMENT 'FK → consumable_sales_alp',
  `item_id` int NOT NULL COMMENT 'FK → consumable_items_alp',
  `quantity` decimal(12,3) NOT NULL,
  `unit_price_usd` decimal(12,4) NOT NULL DEFAULT '0.0000',
  `discount_pct` decimal(5,2) NOT NULL DEFAULT '0.00',
  ...
  KEY `idx_item_id` (`item_id`),
  KEY `idx_movement_id` (`movement_id`),
  CONSTRAINT `fk_csi_item` FOREIGN KEY (`item_id`) REFERENCES `consumable_items_ret` (`id`),
  CONSTRAINT `fk_csi_movement` FOREIGN KEY (`movement_id`) REFERENCES `consumable_movements_ret` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_csi_sale` FOREIGN KEY (`sale_id`) REFERENCES `consumable_sales_ret` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='تفاصيل فواتير بيع المستهلكات';

-- Dumping data for table bayhas_local.consumable_sale_items_ret: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='أرصدة المستهلكات لكل مستودع';

-- Dumping data for table bayhas_local.consumable_stock_ret: ~5 rows (approximately)
INSERT INTO `consumable_stock_ret` (`id`, `item_id`, `warehouse_id`, `quantity`, `min_quantity`, `avg_cost_usd`, `last_movement`, `updated_at`) VALUES
...
INSERT INTO `currencies` (`id`, `code`, `name`, `symbol`, `exchange_rate`, `is_base`, `status`, `updated_at`) VALUES
	...
	(2, 'TRY', 'ليرة تركية', '₺', 45.0000, 0, 'active', '2026-07-16 12:06:03'),
	(3, 'EUR', 'يورو', '€', 0.8810, 0, 'active', '2026-06-25 05:23:11'),
	(4, 'SYP', 'ليرة سورية', 'ل.س', 12500.0000, 0, 'active', '2026-07-16 08:33:25'),
...
-- Dumping data for table bayhas_local.customers_ret: ~1 rows (approximately)
INSERT INTO `customers_ret` (`id`, `name`, `contact_person`, `type`, `phone`, `email`, `address`, `tax_number`, `status`, `shipping_company`, `shipping_code`, `account_id`, `prepaid_account_id`, `created_at`, `updated_at`) VALUES
...
-- Dumping structure for table bayhas_local.employees_ret
CREATE TABLE IF NOT EXISTS `employees_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `position` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'المسمى الوظيفي',
  `department` enum('sales','warehouse','production','accounting','hr','admin','other') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'other',
  `phone` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `national_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hire_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL COMMENT 'تاريخ إنهاء الخدمة',
  `salary_type` enum('monthly','weekly','daily','hourly','piecework') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'monthly' COMMENT 'شهري|أسبوعي|يومي|ساعي|بالقطعة',
  ...
  `payment_day` tinyint DEFAULT '1' COMMENT 'يوم صرف الراتب من الشهر (1-28)',
  `status` enum('active','on_leave','terminated') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` int DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
-- Dumping data for table bayhas_local.employees_ret: ~0 rows (approximately)
...
-- Dumping data for table bayhas_local.inventory_movements_ret: ~1 rows (approximately)
INSERT INTO `inventory_movements_ret` (`id`, `movement_number`, `movement_type`, `warehouse_id`, `items_count`, `total_quantity`, `total_value_usd`, `reference_type`, `reference_id`, `reference_number`, `notes`, `created_by`, `created_at`) VALUES
...
-- Dumping data for table bayhas_local.inventory_movement_details_ret: ~48 rows (approximately)
...
-- Dumping data for table bayhas_local.invoice_account_settings_ret: ~25 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `modules` (
  ...
  KEY `idx_key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=67 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='أقسام النظام وتدرجها';

-- Dumping data for table bayhas_local.modules: ~46 rows (approximately)
...
-- Dumping structure for table bayhas_local.payroll_ret
CREATE TABLE IF NOT EXISTS `payroll_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `employee_id` int NOT NULL,
  ...
  `payment_method` enum('cash','bank','other') COLLATE utf8mb4_unicode_ci DEFAULT 'cash',
  `cash_account_id` int DEFAULT NULL,
  `journal_entry_id` int DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` int NOT NULL,
  ...
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_emp_period` (`employee_id`,`period_start`,`period_end`),
  KEY `idx_period_start` (`period_start`),
  KEY `idx_status` (`status`),
  CONSTRAINT `fk_pay_employee` FOREIGN KEY (`employee_id`) REFERENCES `employees_ret` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table bayhas_local.payroll_ret: ~0 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='الموديلات الأب — بيانات مشتركة';

-- Dumping data for table bayhas_local.products_ret: ~1 rows (approximately)
INSERT INTO `products_ret` (`id`, `model_number`, `name`, `category_id`, `fabric_type`, `supplier_id`, `image_path`, `is_active`, `notes`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(4, '5069', 'بنطلون جينز بناتي طبع وردات عالجيب الخلفي اليمين', 2, 'سكالا', 1, NULL, 1, '', 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:21');
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='قياسات كل موديل — سعر مستقل لكل قياس';

-- Dumping data for table bayhas_local.product_sizes_ret: ~15 rows (approximately)
INSERT INTO `product_sizes_ret` (`id`, `product_id`, `size`, `age_type`, `sort_order`, `selling_price`, `cost_price`, `base_currency_id`, `currency_id`, `exchange_rate`, `margin_pct`, `packet_qty`, `is_active`, `updated_by`, `created_at`, `updated_at`) VALUES
	(37, 4, '2', 'سنة', 0, 11.0000, 10.0000, 1, 1, 1.000000, 10.00, 4, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(38, 4, '3', 'سنة', 1, 11.0000, 10.0000, 1, 1, 1.000000, 10.00, 4, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(39, 4, '4', 'سنة', 2, 11.0000, 10.0000, 1, 1, 1.000000, 10.00, 4, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(40, 4, '5', 'سنة', 3, 11.0000, 10.0000, 1, 1, 1.000000, 10.00, 4, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(41, 4, '6', 'سنة', 4, 16.5000, 15.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(42, 4, '8', 'سنة', 5, 16.5000, 15.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(43, 4, '10', 'سنة', 6, 16.5000, 15.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(44, 4, '11', 'سنة', 7, 22.0000, 20.0000, 1, 1, 1.000000, 10.00, 5, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(45, 4, '12', 'سنة', 8, 22.0000, 20.0000, 1, 1, 1.000000, 10.00, 5, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(46, 4, '13', 'سنة', 9, 22.0000, 20.0000, 1, 1, 1.000000, 10.00, 5, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(47, 4, '14', 'سنة', 10, 22.0000, 20.0000, 1, 1, 1.000000, 10.00, 5, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(48, 4, '15', 'سنة', 11, 22.0000, 20.0000, 1, 1, 1.000000, 10.00, 5, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(49, 4, '16', 'سنة', 12, 27.5000, 25.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(50, 4, '17', 'سنة', 13, 27.5000, 25.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(51, 4, '18', 'سنة', 14, 27.5000, 25.0000, 1, 1, 1.000000, 10.00, 3, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22');
...
-- Dumping data for table bayhas_local.product_suppliers_ret: ~4 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=127 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='كل قياس+لون = سطر — السعر مورث من product_sizes_alp';

-- Dumping data for table bayhas_local.product_variants_ret: ~30 rows (approximately)
INSERT INTO `product_variants_ret` (`id`, `product_id`, `size_id`, `color_id`, `barcode`, `is_active`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
	(73, 4, 37, 14, '5069-V000073', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(74, 4, 38, 14, '5069-V000074', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(75, 4, 39, 14, '5069-V000075', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(76, 4, 40, 14, '5069-V000076', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(77, 4, 41, 14, '5069-V000077', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(78, 4, 42, 14, '5069-V000078', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(79, 4, 43, 14, '5069-V000079', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(80, 4, 44, 14, '5069-V000080', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(81, 4, 45, 14, '5069-V000081', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(82, 4, 46, 14, '5069-V000082', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(83, 4, 47, 14, '5069-V000083', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(84, 4, 48, 14, '5069-V000084', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(85, 4, 37, 13, '5069-V000085', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(86, 4, 38, 13, '5069-V000086', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(87, 4, 39, 13, '5069-V000087', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(88, 4, 40, 13, '5069-V000088', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(89, 4, 41, 13, '5069-V000089', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(90, 4, 42, 13, '5069-V000090', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(91, 4, 43, 13, '5069-V000091', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(92, 4, 44, 13, '5069-V000092', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(93, 4, 45, 13, '5069-V000093', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(94, 4, 46, 13, '5069-V000094', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(95, 4, 47, 13, '5069-V000095', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(96, 4, 48, 13, '5069-V000096', 1, 1, 1, '2026-07-16 11:52:58', '2026-07-16 12:05:22'),
	(109, 4, 49, 14, '5069-V000109', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(110, 4, 50, 14, '5069-V000110', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(111, 4, 51, 14, '5069-V000111', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(124, 4, 49, 13, '5069-V000124', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(125, 4, 50, 13, '5069-V000125', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22'),
	(126, 4, 51, 13, '5069-V000126', 1, 1, 1, '2026-07-16 12:05:22', '2026-07-16 12:05:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='العطل الرسمية — فرع حلب';
...
INSERT INTO `purchases_ret` (`id`, `purchase_number`, `supplier_id`, `created_by`, `purchase_date`, `due_date`, `total_amount`, `tax_amount`, `discount_amount`, `final_amount`, `final_amount_base_currency`, `paid_amount`, `balance_amount`, `currency`, `invoice_currency_id`, `base_currency_id`, `warehouse_id`, `exchange_rate`, `payment_status`, `payment_method`, `journal_entry_id`, `notes`, `status`, `user_id`, `updated_by`, `created_at`, `updated_at`) VALUES
	(6, 'PUR-2026-00001', 1, 1, '2026-07-17', '2026-07-17', 6291.00, 0.00, 0.00, 6291.00, 139.8000, 0.0000, 6291.0000, 'TRY', 2, 1, 1, 45.0000, 'pending', 'cash', NULL, '', 'draft', 1, NULL, '2026-07-17 00:32:38', NULL);
...
-- Dumping data for table bayhas_local.purchase_items_ret: ~30 rows (approximately)
INSERT INTO `purchase_items_ret` (`id`, `purchase_id`, `product_id`, `variant_id`, `quantity`, `unit_price`, `unit_price_base_currency`, `total_price`, `discount_amount`, `created_at`, `discount_percentage`, `created_by`, `updated_by`, `updated_at`) VALUES
	(151, 6, 4, 73, 1.00, 450.0000, 10.0000, 441.00, 9.00, '2026-07-17 00:32:38', 2.00, 1, NULL, NULL),
	(152, 6, 4, 74, 1.00, 450.0000, 10.0000, 441.00, 9.00, '2026-07-17 00:32:38', 2.00, 1, NULL, NULL),
	(153, 6, 4, 75, 1.00, 450.0000, 10.0000, 441.00, 9.00, '2026-07-17 00:32:38', 2.00, 1, NULL, NULL),
	(154, 6, 4, 76, 1.00, 450.0000, 10.0000, 441.00, 9.00, '2026-07-17 00:32:38', 2.00, 1, NULL, NULL),
	(155, 6, 4, 85, 1.00, 450.0000, 10.0000, 450.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(156, 6, 4, 86, 1.00, 450.0000, 10.0000, 450.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(157, 6, 4, 87, 1.00, 450.0000, 10.0000, 450.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(158, 6, 4, 88, 1.00, 450.0000, 10.0000, 450.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(159, 6, 4, 77, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(160, 6, 4, 78, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(161, 6, 4, 79, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(162, 6, 4, 89, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(163, 6, 4, 90, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(164, 6, 4, 91, 1.00, 675.0000, 15.0000, 675.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(165, 6, 4, 80, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(166, 6, 4, 81, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(167, 6, 4, 82, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(168, 6, 4, 83, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(169, 6, 4, 84, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(170, 6, 4, 92, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(171, 6, 4, 93, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(172, 6, 4, 94, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(173, 6, 4, 95, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(174, 6, 4, 96, 1.00, 900.0000, 20.0000, 900.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(175, 6, 4, 109, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(176, 6, 4, 110, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:38', 0.00, 1, NULL, NULL),
	(177, 6, 4, 111, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:39', 0.00, 1, NULL, NULL),
	(178, 6, 4, 124, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:39', 0.00, 1, NULL, NULL),
	(179, 6, 4, 125, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:39', 0.00, 1, NULL, NULL),
	(180, 6, 4, 126, 1.00, 1125.0000, 25.0000, 1125.00, 0.00, '2026-07-17 00:32:39', 0.00, 1, NULL, NULL);
...
-- Dumping structure for table bayhas_local.raw_materials_ret
CREATE TABLE IF NOT EXISTS `raw_materials_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(150) COLLATE utf8mb4_unicode_ci NOT NULL,
  `unit` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'kg' COMMENT 'كغ، متر، قطعة، لفّة',
...
-- Dumping data for table bayhas_local.raw_materials_ret: ~0 rows (approximately)

-- Dumping structure for table bayhas_local.raw_material_stock_ret
CREATE TABLE IF NOT EXISTS `raw_material_stock_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_rms_material` FOREIGN KEY (`material_id`) REFERENCES `raw_materials_ret` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table bayhas_local.raw_material_stock_ret: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `sales_invoices_ret` (
  ...
  `customer_id` int NOT NULL,
  `customer_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `customer_type` enum('internal','external') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'external',
  `invoice_date` date NOT NULL,
  `due_date` date DEFAULT NULL,
  ...
  `shipping_carrier_id` int DEFAULT NULL,
  `shipping_cost` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'أجرة النقلية TRY',
  `shipping_payment_method` enum('cash','card','bank') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
  `number_of_packages` int NOT NULL DEFAULT '0',
  `shipping_fees` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT 'أجور الشحن على العميل',
  `payment_method` enum('cash','card','bank','half_cash_half_bank','deferred','check','credit') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
  `payment_status` enum('pending','partial','paid') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  ...
  `status` enum('draft','pending','confirmed','partially_paid','paid','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'draft',
  ...
  KEY `idx_carrier_id` (`shipping_carrier_id`),
  CONSTRAINT `fk_si_carrier` FOREIGN KEY (`shipping_carrier_id`) REFERENCES `shipping_carriers_ret` (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_si_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers_ret` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='فواتير البيع — جميع المبالغ بالدولار USD';
...
CREATE TABLE IF NOT EXISTS `sales_invoice_items_ret` (
  ...
  KEY `idx_variant_id` (`variant_id`),
  KEY `idx_barcode` (`barcode`),
  CONSTRAINT `fk_sii_invoice` FOREIGN KEY (`invoice_id`) REFERENCES `sales_invoices_ret` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table bayhas_local.shipping_carriers_ret
CREATE TABLE IF NOT EXISTS `shipping_carriers_ret` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_person` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tax_number` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account_id` int DEFAULT NULL,
  `payable_account_id` int DEFAULT NULL COMMENT 'حساب ذمة النقلية',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `status` enum('active','inactive') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `created_by` int DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- Dumping data for table bayhas_local.shipping_carriers_ret: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  KEY `idx_is_active` (`is_active`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='المستخدمون';

-- Dumping data for table bayhas_local.users: ~2 rows (approximately)
...
-- Dumping data for table bayhas_local.user_branches: ~2 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='صلاحيات كل مستخدم في كل فرع على كل قسم';
...
INSERT INTO `warehouses_ret` (`id`, `code`, `name`, `address`, `manager_id`, `is_active`, `created_at`) VALUES
	(1, 'WH-01', 'المستودع الرئيسي للمنتجات', NULL, NULL, 1, '2026-05-20 11:51:25'),
...
) ENGINE=InnoDB AUTO_INCREMENT=1925 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='مخزون كل Variant في كل مستودع';

-- Dumping data for table bayhas_local.warehouse_items_ret: ~30 rows (approximately)
INSERT INTO `warehouse_items_ret` (`id`, `warehouse_id`, `variant_id`, `product_id`, `quantity`, `min_quantity`, `last_movement_at`, `status`, `created_at`, `updated_at`) VALUES
	(1871, 1, 73, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1872, 1, 74, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1873, 1, 75, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1874, 1, 76, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1875, 1, 77, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1876, 1, 78, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1877, 1, 79, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1878, 1, 80, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1879, 1, 81, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1880, 1, 82, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1881, 1, 83, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1882, 1, 84, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1883, 1, 85, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1884, 1, 86, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1885, 1, 87, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1886, 1, 88, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1887, 1, 89, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1888, 1, 90, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1889, 1, 91, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1890, 1, 92, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1891, 1, 93, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1892, 1, 94, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1893, 1, 95, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1894, 1, 96, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 11:52:58', NULL),
	(1919, 1, 109, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL),
	(1920, 1, 110, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL),
	(1921, 1, 111, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL),
	(1922, 1, 124, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL),
	(1923, 1, 125, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL),
	(1924, 1, 126, 4, 0.00, 0.00, NULL, 'active', '2026-07-16 12:05:22', NULL);
